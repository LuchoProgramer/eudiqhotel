...
export const habitaciones = [
  {
    ...
    amenidades: ['Wi-Fi gratis', 'TV Cable', 'Baño privado', 'Escritorio', 'Desayuno incluido'],
  },
  {
    id: 2,
    nombre: 'Matrimonial',
  ...
  amenidades: ['Wi-Fi gratis', 'TV Cable', 'Baño privado', 'Desayuno incluido'],
  },
  {
    id: 3,
    nombre: 'Doble cama',
  ...
  },
  {
    ...
    nombre: 'Cuádruple',
    categoria: 'CUÁDRUPLE',
    descripcion: 'Habitación para cuatro personas. El precio es por persona ($20). Incluye desayuno.',
    precio: 20,
  ...
  },
  {
    ...
    nombre: 'Familiar',
    categoria: 'FAMILIA',
    descripcion: 'Habitación familiar. El precio es por persona ($20). Incluye desayuno.',
    precio: 20,
    capacidad: 'por persona',
    ...
    imagenes: [
      {
        ...
        alt: 'Habitación Familiar en Eudiq Hotel Loja, espacio para familias',
      },
    ],
    amenidades: ['Wi-Fi gratis', 'TV Cable', 'Baño privado', 'Desayuno incluido'],
  },
