...
export const metadata: Metadata = {
  ...
  description: 'Hotel perfecto para graduación UTPL. Habitaciones familiares, desayuno incluido, a 15 min del campus. Tarifas especiales para grupos familiares.',
