...
import { trackWhatsappClick, trackPhoneClick } from '@/components/ConversionOptimizer';
    ...
    {[
      ...
      <div key={index} className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
        ...
        <a
          ...
          onClick={() => trackWhatsappClick(`blog_graduation_dates_${fecha.mes.toLowerCase().replace(' ', '_')}`)}
        >
          Ver disponibilidad
        </a>
      </div>
  ...
  <div className="bg-white rounded-xl p-6 sticky top-8 shadow-lg border border-gray-100">
    ...
    <div className="space-y-3 text-sm">
      ...
      <a
        ...
        onClick={() => trackWhatsappClick('blog_sidebar_quickinfo')}
      >
  ...
  <div className="bg-white border-2 border-[#038C7F]/20 rounded-xl p-6 my-8">
    ...
    <div className="grid md:grid-cols-4 gap-4">
      ...
      <a
        ...
        onClick={() => trackWhatsappClick('blog_inline_form')}
      >
        Consultar
      </a>
    </div>
            ...
            <div className="max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  onClick={() => trackWhatsappClick('blog_hero_main')}
                >
                ...
                <a
                  ...
                  onClick={() => trackPhoneClick('blog_hero_phone')}
                >
                  <Phone className="h-5 w-5" />
                  +593 96 171 2106
                </a>
                  ...
                  <div className="max-w-2xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      ...
                      <a
                        ...
                        onClick={() => trackPhoneClick('blog_footer_phone')}
                      >
                        <Phone className="h-5 w-5" />
                        Llamar ahora
                      </a>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 shadow-xl z-50">
        <div className="flex items-center justify-between">
          ...
          <a
            ...
            onClick={() => trackWhatsappClick('blog_mobile_sticky_bar')}
          >
            <Phone className="h-4 w-4" />
            Reservar
          </a>
