                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-lg text-gray-700">
                            Te esperamos en Hotel Eudiq. ¡El mejor ambiente de Loja!
                        </p>
                    </div>

                    {/* Botones principales - AJUSTADO UX CONTACTO */}
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
                        {/* NO DELIVERY - Ajustado a consulta */}
                        <CTAButton
                            variant="secondary"
                            size="large"
                            href="https://api.whatsapp.com/send?phone=593961712106&text=Hola, quisiera reservar una mesa o consultar disponibilidad en Cafeter%C3%ADa Viviates"
                            section="menu_reserve_whatsapp"
                            className="bg-[#038C7F] text-white hover:bg-[#026B61] flex items-center gap-2 font-bold"
                            onClick={() => trackWhatsAppClick('reservation', 'menu_cta_primary', 'Reserva/Consulta')}
                        >
                            <MessageCircle className="h-5 w-5" />
                            Reservar / Consultar WhatsApp
                        </CTAButton>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 text-center">
                            ...
                            <p className="text-xs text-gray-700 font-bold text-center">
                                07:00 - 11:00 (Desayunos)<br />
                                16:00 - 21:00 (Café y Cena)
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-center mt-8">
                        <Link
                            ...
                            title="Volver a página principal Cafetería Viviates Loja"
                        >
            ...
            <section className="py-6 bg-gray-50 border-t border-gray-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
                    <p className="text-sm text-gray-600">
                        * El menú puede variar según disponibilidad. Precios incluyen IVA. Ubicado en Hotel Eudiq.
                    </p>
                </div>
            </section>
        </main>
