...
const galeriaFotos = [
  ...
  { url: 'https://res.cloudinary.com/dltfsttr7/image/upload/v1761843579/Imagen_de_WhatsApp_2025-10-29_a_las_19.43.22_2904e769_vhu9hl.jpg', categoria: 'Habitaciones', alt: 'Habitación Triple' },
  ...
  { url: 'https://res.cloudinary.com/dltfsttr7/image/upload/v1761847748/WhatsApp_Image_2025-10-29_at_19.40.30_1_qshs8i.jpg', categoria: 'Cafetería', alt: 'Cafetería Viviates - Deliciosos Tacos' },
  ...
  { url: 'https://res.cloudinary.com/dltfsttr7/image/upload/v1761847761/WhatsApp_Image_2025-10-29_at_19.40.29_1_hywgib.jpg', categoria: 'Cafetería', alt: 'Cafetería Viviates - artelatte' },
  { url: 'https://res.cloudinary.com/dltfsttr7/image/upload/v1761847772/WhatsApp_Image_2025-10-29_at_19.40.28_2_vo2mtv.jpg', categoria: 'Cafetería', alt: 'Cafetería Viviates - Baristas especializados' },
  { url: 'https://res.cloudinary.com/dltfsttr7/image/upload/v1761847767/WhatsApp_Image_2025-10-29_at_19.40.29_dadbdl.jpg', categoria: 'Cafetería', alt: 'Cafetería Viviates - Postres' },
  { url: 'https://res.cloudinary.com/dltfsttr7/image/upload/v1764625179/WhatsApp_Image_2025-11-27_at_14.56.04_1_nxu6qe.jpg', categoria: 'Cafetería', alt: 'Cafetería Viviates - ambiente interior' },
        ...
        <div className={`flex flex-wrap justify-center gap-3 mb-12 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          {categorias.map((cat) => (
            <button
              ...
              className={`px-6 py-2 rounded-full font-semibold text-sm transition-all ${categoriaActiva === cat
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 space-y-4">
          {fotosFiltradas.map((foto, idx) => (
            <div
              ...
              className={`relative group cursor-pointer break-inside-avoid transition-all duration-500 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'
                }`}
